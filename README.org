...
* Tipos inductivos (árboles).

** Razonamiento sobre árboles binarios

*** Razonamiento sobre árboles binarios: La función espejo es involutiva
    Enlaces al [[./src/8_Arboles/Pruebas_de_que_la_funcion_espejo_de_los_arboles_binarios_es_involutiva.lean][código]] y a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/8_Arboles/Pruebas_de_que_la_funcion_espejo_de_los_arboles_binarios_es_involutiva.lean][sesión en Lean Web]].
    #+INCLUDE: "./src/8_Arboles/Pruebas_de_que_la_funcion_espejo_de_los_arboles_binarios_es_involutiva.lean" src lean
