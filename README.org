...
+ Enlaces al [[./src/6_Naturales/Pruebas_de_m^(succ_n)_Eq_m_por_m^n.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/6_Naturales/Pruebas_de_m^(succ_n)_Eq_m_por_m^n.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/6_Naturales/Pruebas_de_m^(succ_n)_Eq_m_por_m^n.lean" src lean
