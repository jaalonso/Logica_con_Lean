...
+ Enlaces al [[./src/2_LPO/Pruebas_de_y=xIy=zIx=z.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/2_LPO/Pruebas_de_y=xIy=zIx=z.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/2_LPO/Pruebas_de_y=xIy=zIx=z.lean" src lean 
