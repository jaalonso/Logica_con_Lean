...
*** Pruebas de ¬Q → ¬P ⊢ P → ¬¬Q
+ Enlaces al [[./src/1_Proposicional/Pruebas_de_¬Q→¬P⊢P→¬¬Q.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/1_Proposicional/Pruebas_de_¬Q→¬P⊢P→¬¬Q.lean][sesión en Lean Web]] y al vídeo.
