...
+ Enlaces al [[./src/3_Conjuntos/Monotonia_del_conjunto_potencia.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/3_Conjuntos/Monotonia_del_conjunto_potencia.lean][sesión en Lean Web]] y al vídeo.
...
+ Enlaces al [[./src/4_Relaciones/Las_partes_estrictas_son_irreflexivas.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/4_Relaciones/Las_partes_estrictas_son_irreflexivas.lean][sesión en Lean Web]] y al vídeo.
...
+ Enlaces al [[./src/4_Relaciones/Las_partes_simetricas_son_simetricas.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/4_Relaciones/Las_partes_simetricas_son_simetricas.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/4_Relaciones/Las_partes_simetricas_son_simetricas.lean" src lean 

** Órdenes sobre números

*** Pruebas de n + 1 ≤ m ⊢ n < m + 1
+ Enlaces al [[./src/4_Relaciones/Pruebas_de_desigualdad_entre_naturales.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/4_Relaciones/Pruebas_de_desigualdad_entre_naturales.lean][sesión en Lean Web]] y al vídeo.
...
+ Enlaces al [[./src/4_Relaciones/Las_equivalencias_son_preordenes_simetricos.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/4_Relaciones/Las_equivalencias_son_preordenes_simetricos.lean][sesión en Lean Web]] y al vídeo.
...
+ Enlaces al [[./src/4_Relaciones/Definicion_de_la_composicion_de_funciones.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/4_Relaciones/Definicion_de_la_composicion_de_funciones.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/4_Relaciones/Definicion_de_la_composicion_de_funciones.lean" src lean 

*** Definición de la función identidad
+ Enlaces al [[./src/4_Relaciones/Definicion_de_la_funcion_identidad.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/4_Relaciones/Definicion_de_la_funcion_identidad.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/4_Relaciones/Definicion_de_la_funcion_identidad.lean" src lean 

*** Extensionalidad funcional
+ Enlaces al [[./src/4_Relaciones/Extensionalidad_funcional.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/4_Relaciones/Extensionalidad_funcional.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/4_Relaciones/Extensionalidad_funcional.lean" src lean 

*** Propiedades de la composición de funciones (elemento neutro y asociatividad)
+ Enlaces al [[./src/4_Relaciones/Propiedades_de_la_composicion_de_funciones.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/4_Relaciones/Propiedades_de_la_composicion_de_funciones.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/4_Relaciones/Propiedades_de_la_composicion_de_funciones.lean" src lean 

*** Funciones inyectivas, suprayectivas y biyectivas
+ Enlaces al [[./src/4_Relaciones/Funciones_inyectivas_suprayectivas_y_biyectivas.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/4_Relaciones/Funciones_inyectivas_suprayectivas_y_biyectivas.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/4_Relaciones/Funciones_inyectivas_suprayectivas_y_biyectivas.lean" src lean 

*** La identidad es biyectiva
+ Enlaces al [[./src/4_Relaciones/La_identidad_es_biyectiva.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/4_Relaciones/La_identidad_es_biyectiva.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/4_Relaciones/La_identidad_es_biyectiva.lean" src lean 
