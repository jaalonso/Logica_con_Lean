...
+ Enlaces al [[./src/3_Conjuntos/Pruebas_de_A∩(B∪C)=(A∩B)∪(A∩C).lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/3_Conjuntos/Pruebas_de_A∩(B∪C)=(A∩B)∪(A∩C).lean][sesión en Lean Web]] y al vídeo.
