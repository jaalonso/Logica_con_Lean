...
+ Enlaces al [[./src/1_Proposicional/Pruebas_del_modus_tollens.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/1_Proposicional/Pruebas_del_modus_tollens.lean][sesión en Lean Web]] y al vídeo.
...
*** Pruebas de la regla de introducción de la doble negación: P ⊢ ¬¬P
