...
#+IN→LUDE: "./src/2_LPO/Pruebas_de_yIx→yIz→xIz.lean" src lean 

*** Pruebas de (x + y) + z = (x + z) + y
+ Enlaces al [[./src/2_LPO/Pruebas_de_(x+y)+z=(x+z)+y.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/2_LPO/Pruebas_de_(x+y)+z=(x+z)+y.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/2_LPO/Pruebas_de_(x+y)+z=(x+z)+y.lean" src lean 
