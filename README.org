...
+ Enlaces al [[./src/1_Proposicional/Eliminacion_del_condicional.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/1_Proposicional/Eliminacion_del_condicional.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/1_Proposicional/Eliminacion_del_condicional.lean" src lean 
#+INDEX: Órdenes!import
#+INDEX: Órdenes!variables
#+INDEX: Órdenes!example
#+INDEX: Órdenes!begin
#+INDEX: Órdenes!end
#+INDEX: Órdenes!by
...
+ Enlaces al [[./src/1_Proposicional/Introduccion_del_condicional.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/1_Proposicional/Introduccion_del_condicional.lean][sesión en Lean Web]] y al vídeo.
