...
+ Enlaces al [[./src/4_Relaciones/Pruebas_de_n+1≤m⊢n<m+1.lean][código]], a la [[https://www.cs.us.es/~jalonso/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/Logica_con_Lean/master/src/4_Relaciones/Pruebas_de_n+1≤m⊢n<m+1.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/4_Relaciones/Pruebas_de_n+1≤m⊢n<m+1.lean" src lean 
